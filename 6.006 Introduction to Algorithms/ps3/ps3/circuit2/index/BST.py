...
class BSTNode(object):
    ...
    def find2(self, k):
        ...
        if k == self.key:
            ...
            if self.left is None:
                ...
                return self.left.find2(k)
        else:
            if self.right is None:  
                return self.next_larger()
            else:
                return self.right.find2(k)
    ...
    def list(self, k1, k2, result = []):
        ...
        if(self.key >= k1 and self.key <= k2):
...
class BST(object):
    ...
    def find2(self, k):
        ...
        Running Time:
            O(log(n))
        """
        return self.root and self.root.find2(k)
    ...
    def remove(self, k, value):
        ...
        if(len(node.values)>0):
            ...
            if(node is self.root):
                pseudoroot = self.node_class(0, None, None)
    ...
    def list(self, k1, k2, result):
        ...
        return self.root and self.root.list(k1, k2, result)
